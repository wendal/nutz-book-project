package net.wendal.nutzbook.common.websocket;
...
public class NutzbookWebsocket extends Endpoint implements PubSub {
    ...
    protected static ConcurrentHashMap<String, NutzbookWsStringHandler> _sessions = new ConcurrentHashMap<>();
    /** WebSocketSession.id --> UU32 */
    protected static ConcurrentHashMap<String, String> sessionIds = new ConcurrentHashMap<String, String>();
