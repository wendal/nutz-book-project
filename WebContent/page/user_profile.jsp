 ...
 %>
	...
	<div>
		<form action="#" id="user_profile" method="post">
			<div>
				昵称:<input name="nickname" value="${user_profile.nickname}"><p />
			</div>
			<div>
			...
			<div>
				性别:<input name="gender" value="${user_profile.gender}"><p />
			</div>
			<div>
				自我介绍:<input name="description" value="${user_profile.description}"><p />
			</div>
			<div>
				地理位置:<input name="location" value="${user_profile.location}"><p />
			</div>
		</form>
