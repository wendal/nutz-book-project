...
import net.wendal.nutzbook.yvr.mvc.AccessTokenFilter;
...
public class YvrApiModule extends BaseModule {
	...
	public Object topic(@Param("id")String id, @Param("mdrender")String mdrender, @Param("gcnt")String gcnt) {
		...
		NutMap tp = _topic(topic, new HashMap<Long, UserProfile>(), mdrender, !"false".equals(gcnt));
	...
	public NutMap _topic(Topic topic, Map<Long, UserProfile> authors, String mdrender, boolean hasContent) {
